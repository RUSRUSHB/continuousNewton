...
[f, df, name, x0] = testFunctionsChallenging.highlyOscillatory5();
% [f, df, name, x0] = testFunctions.illConditioned();
...
if show_continuous
    text_str = [text_str sprintf('Continuous Newton iterations: %d', iter_cont)];
end
if ~isempty(text_str)
